...
public class LoadingScreen : MonoBehaviour
{
    ...
    private IEnumerator LoadingScreenCoroutine()
    {
        ...
        var sceneLoading = SceneManager.LoadSceneAsync("Play");               //On stocke dans la variable sceneLoading, la scène du jeu qui se charge en arrière plan
        ...
        while (sceneLoading.isDone == false)                                        //Tant que la scène de jeu n'est pas chargée
        {
            ...
            {
                if (sceneLoading.allowSceneActivation = true);                        //On autorise la scène du jeu à se lancer
